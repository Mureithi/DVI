<script>
	$(function() {
		...
		var url = '<?php echo base_url()."months_of_stock/get_mos_balance/0/0/1"?>'; 
		...
		var url = '<?php echo base_url()."cold_chain/get_utilization/0/0/1"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_fridge_occupancy/0/0/1"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_freezer_occupancy/0/0/1"?>';  
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."mos_trend/get/0/0/0/0/1"?>';  
		chart.setDataURL(url);
		...
		$(".view_larger_graph").click(function(){
			...
			if(id == "forecast_graph"){
				...
				var url = '<?php echo base_url()."consumption_forecast/forecast/0/0/0/0/1"?>';  
				chart.setDataURL(url);
			...
			if(id == "recipients_graph"){
				...
				var url = '<?php echo base_url()."antigen_recipients/recipients/0/0/0/0/0/1"?>'; 
				chart.setDataURL(url);
...
<div class="larger_graph">
	<a class="link view_larger_graph" href="#" id="mos_graph">Enlarge</a> | <a class="link" href="<?php echo base_url().'months_of_stock/download/0/0/1';?>">Download Data</a>
</div>
<div id="mos_legend">
...
<div class="larger_graph">
	<a class="link view_larger_graph" id="cold_chain_graph">Enlarge</a> |<a class="link" href="<?php echo base_url().'cold_chain/download/0/0/1';?>">Download Data</a>
</div>
...
<div class="larger_graph" style="margin-top: -20px;">
	<a class="link view_larger_graph" id="mos_trend_graph">View More</a> | <a class="link" href="<?php echo base_url().'mos_trend/download_mos_trend/0/0/0/1';?>">Download Data</a>
</div>
