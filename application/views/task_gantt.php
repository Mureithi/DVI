...
<?php $email = Shipments::get_task_id();
		...
		$string.= "<chart manageResize='2'dateFormat='dd/mm/yyyy' outputDateFormat='ddds mns yy' ganttWidthPercent='40' canvasBorderColor='999999' canvasBorderThickness='0' gridBorderColor='4567aa' gridBorderAlpha='20' ganttPaneDuration='3' ganttPaneDurationUnit='m' >
...
$string.="</chart>";
 ...
 echo renderChart("".base_url()."FusionWidgets/Charts/Gantt.swf","", rawurlencode($string),"myChartId", "92%", 500, false, false);
 ?>
...
<?php $email = Shipments::get_task_id();
		...
		$string.= "<chart manageResize='5' dateFormat='dd/mm/yyyy' outputDateFormat='ddds mns yy' ganttWidthPercent='40' canvasBorderColor='999999' canvasBorderThickness='0' gridBorderColor='4567aa' gridBorderAlpha='20' ganttPaneDuration='3' ganttPaneDurationUnit='m' >
<categories  bgColor='009999'>";
		...
		foreach  ($task_id as $task_id)
		 {
			...
			@$endx = $task_id['end_date'];
			@$end=date('d/m/Y', strtotime($endx));;
			$string.= "<task label='Planned' processId='$id' start='$initial2' end='$end' id='$id-1' color='4567aa' height='22%' topPadding='10%'/>";
			$string.= "<task label='Actual' processId='$id' start='$start' end='$end' id='$id' color='EEEEEE' alpha='100'  topPadding='56%' height='22%' />";
