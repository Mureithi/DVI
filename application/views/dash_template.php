...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url().'Images/img/coat_of_arms.png'?>" type="image/x-icon" />
...
<div class="navbar navbar-default navbar-fixed-top">
   <div class="container" style="border-bottom: 2px solid #C0C0C0;width: 100%" >
        <div class="navbar-header " >
          ...
          <img style="display:inline-block;" src="<?php echo base_url();?>Images/coat_of_arms-resized1.png" class="img-responsive " alt="Responsive image">
